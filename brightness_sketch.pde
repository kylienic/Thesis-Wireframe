...
void drawEquation(){
  ...
  //black border
  rect(300-20, 400+10, 446+20, 234+10);
  //inner white rectangle 
  fill(255);
  rect(302-20, 402+10, 442+20, 230+10);
  // text label
  fill(0);
  ...
  textLeading(12);
  textSize(14);
  text("BRIGHTNESS", 300, 429);
  textSize(12);
  text(brighttext, 300, 445);
  textSize(14);
  text("BRIGHTNESS ALGORITHM", 300, 485);
  fill(0);
  textSize(22);
  text("new = original + brightValue", 300, 509);
  textSize(14);
