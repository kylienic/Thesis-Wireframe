...
void drawEquation(){
  ...
  //black border
  rect(300, 400, 450, 250);
  //inner white rectangle 
  fill(255);
  rect(303, 403, 444, 244);
  // text label
  fill(0);
  ...
  fill(0);
  textSize(30);
  text("new = original + brightValue", 320, 520);
  //249 110 64
...
//  text(cords, 380, 585);
  ...
  text(stringRed, 380, 555);
  text(stringG, 380, 570);
  text(stringB, 380, 585);
